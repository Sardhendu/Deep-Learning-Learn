...
class Train():
    ...
    def train_network(self, graph_dict):
        with tf.Session() as sess:
            ...
            aa = np.array([[1,2,3,4,5], [1,3,4,0,0]])  # , [2,3,4,5,6], [2,1,5,4,3]
            bb = np.array([[2,3,4,5,6], [3,4,6,0,0]])  # , [3,4,5,6,2], [1,5,4,3,2]
            ab = np.array([5,3])
...
#                 print (graph_dict)
                new_state_ = None
                for m,n,o in [[aa,bb,ab],[cc,dd,cd]]:#np.arange(2):  # no in np.arange(num_batches):
